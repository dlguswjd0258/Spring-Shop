...
public class HistoryVO {
	//table
	private int h_idx, u_idx, p_idx, o_idx, p_cnt, delivery;
	private String p_color, p_size, buydate;
	
	//veiw
	private int p_price, p_saleprice, amount;
	private String p_name, filename_s;
