...
public class ViewPaging {
	public static String FloatgetPaging(String pageURL,int nowPage, String view_name, int rowTotal,int blockList, int blockPage){
...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			sb.append("<a href ='"+pageURL+"?view_name="+view_name+"&page=");
