 ...
 */
public class ProductListManagerPaging {
	public static String getPaging(String pageURL,int nowPage, String category, int rowTotal,int blockList, int blockPage){
...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			sb.append("<a href ='"+pageURL+"?category="+category+"&page=");
