	...
	<script type="text/javascript">
		...
		function resultFn() {
			if(xhr.readyState == 4 && xhr.status == 200){
				...
				location.href="pwd_reset_form.do?" + data;
			}
		}
	</script>
</head>
<body>
	...
	<div id="main">
		<div class="title">
			<h2>비밀번호 찾기</h2>
			<p>회원가입 시, 입력하신 아이디 + 이름 + 휴대폰 번호 또는 이메일로 비밀번호를 확인하실 수 있습니다.</p>
		</div>
		<div id="form_div">
			<form id="f">
				<table>
					...
					<tr>
						<th class="lable">아이디</th>
						<td><input class="input" name="id" value="${ param.id }"></td>
					...
					<tr>
						<td colspan="2" align="center">
							<input id="findButton" type="button" value="비밀번호 찾기"
									onclick="id_find(this.form)"><br>
